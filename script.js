...
(function () {
  ...
  /* ---- Category poster art (hand-drawn SVG, no external photos) ---- */
  const CATEGORY_THEME = {
    "Cultural":           { grad: "135deg,#FF3D6E,#6C5CE7", icon: "mask" },
    "Technical":          { grad: "135deg,#22D3EE,#2ECC71", icon: "chip" },
    "Sports":             { grad: "135deg,#FF9F43,#FF3D6E", icon: "trophy" },
    "Symposium":          { grad: "135deg,#6C5CE7,#22D3EE", icon: "mic" },
    "Workshop":           { grad: "135deg,#A29BFE,#6C5CE7", icon: "gear" },
    "Workshops":          { grad: "135deg,#A29BFE,#6C5CE7", icon: "gear" },
    "Seminar":            { grad: "135deg,#2ECC71,#22D3EE", icon: "screen" },
    "Competition":        { grad: "135deg,#FF3D6E,#FF9F43", icon: "medal" },
    "Hackathon":          { grad: "135deg,#181530,#6C5CE7", icon: "code" },
    "Quiz":                { grad: "135deg,#22D3EE,#6C5CE7", icon: "question" },
    "Photography":        { grad: "135deg,#2ECC71,#FF9F43", icon: "camera" },
    "Business":           { grad: "135deg,#6C5CE7,#FF3D6E", icon: "chart" },
    "Club Activities":    { grad: "135deg,#FF9F43,#2ECC71", icon: "spark" },
    "Department Events":  { grad: "135deg,#A29BFE,#FF3D6E", icon: "cap" },
    "College Life":       { grad: "135deg,#2ECC71,#A29BFE", icon: "campus" }
  };
  const DEFAULT_THEME = { grad: "135deg,#FF3D6E,#6C5CE7", icon: "spark" };

  const ICON_PATHS = {
    mask:     '<path d="M120 90c0-38 36-58 80-58s80 20 80 58c0 46-34 76-80 76s-80-30-80-76z" fill="none" stroke="#fff" stroke-width="6" opacity=".9"/><circle cx="165" cy="88" r="7" fill="#fff"/><circle cx="235" cy="88" r="7" fill="#fff"/><path d="M160 128q40 26 80 0" stroke="#fff" stroke-width="6" fill="none" stroke-linecap="round"/>',
    chip:     '<rect x="130" y="70" width="140" height="140" rx="14" fill="none" stroke="#fff" stroke-width="6"/><rect x="162" y="102" width="76" height="76" rx="8" fill="#fff" opacity=".85"/><g stroke="#fff" stroke-width="6"><path d="M150 70V40M200 70V40M250 70V40M150 240v-30M200 240v-30M250 240v-30M130 100H100M130 150H100M130 200H100M270 100h30M270 150h30M270 200h30"/></g>',
    trophy:   '<path d="M150 70h100v40c0 34-22 58-50 58s-50-24-50-58V70z" fill="none" stroke="#fff" stroke-width="6"/><path d="M150 78h-24c0 30 12 46 30 50M250 78h24c0 30-12 46-30 50" stroke="#fff" stroke-width="6" fill="none" stroke-linecap="round"/><path d="M188 168v26h24v-26" fill="none" stroke="#fff" stroke-width="6"/><path d="M160 224h80l-10-20h-60z" fill="#fff" opacity=".85"/>',
    mic:      '<rect x="178" y="60" width="44" height="90" rx="22" fill="#fff" opacity=".9"/><path d="M150 130c0 34 24 58 50 58s50-24 50-58" fill="none" stroke="#fff" stroke-width="6" stroke-linecap="round"/><path d="M200 188v34M172 222h56" stroke="#fff" stroke-width="6" stroke-linecap="round"/>',
    gear:     '<circle cx="200" cy="150" r="34" fill="none" stroke="#fff" stroke-width="6"/><circle cx="200" cy="150" r="10" fill="#fff"/><g stroke="#fff" stroke-width="10" stroke-linecap="round"><path d="M200 96v20M200 184v20M254 150h-20M166 150h-20M238 112l-14 14M176 188l-14 14M238 188l-14-14M176 112l-14-14"/></g>',
    screen:   '<rect x="130" y="80" width="140" height="94" rx="10" fill="none" stroke="#fff" stroke-width="6"/><path d="M170 200h60M200 174v26" stroke="#fff" stroke-width="6" stroke-linecap="round"/><path d="M155 150l24-24 20 16 30-34" fill="none" stroke="#fff" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>',
    medal:    '<circle cx="200" cy="168" r="44" fill="none" stroke="#fff" stroke-width="6"/><path d="M200 140l9 18 20 3-14 14 3 20-18-10-18 10 3-20-14-14 20-3z" fill="#fff" opacity=".9"/><path d="M178 90l-24 40M222 90l24 40" stroke="#fff" stroke-width="6" stroke-linecap="round"/>',
    code:     '<path d="M160 100l-46 50 46 50M240 100l46 50-46 50" fill="none" stroke="#fff" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"/><path d="M212 90l-24 120" stroke="#fff" stroke-width="6" stroke-linecap="round" opacity=".85"/>',
    question: '<circle cx="200" cy="150" r="60" fill="none" stroke="#fff" stroke-width="6"/><path d="M180 130a20 20 0 1 1 30 18c-8 5-10 10-10 20" fill="none" stroke="#fff" stroke-width="7" stroke-linecap="round"/><circle cx="200" cy="196" r="5" fill="#fff"/>',
    camera:   '<rect x="130" y="110" width="140" height="90" rx="12" fill="none" stroke="#fff" stroke-width="6"/><path d="M168 110l10-18h44l10 18" fill="none" stroke="#fff" stroke-width="6" stroke-linejoin="round"/><circle cx="200" cy="156" r="28" fill="none" stroke="#fff" stroke-width="6"/><circle cx="200" cy="156" r="10" fill="#fff"/>',
    chart:    '<path d="M120 210h160" stroke="#fff" stroke-width="6" stroke-linecap="round"/><rect x="140" y="160" width="24" height="50" fill="#fff" opacity=".85"/><rect x="188" y="130" width="24" height="80" fill="#fff" opacity=".9"/><rect x="236" y="100" width="24" height="110" fill="#fff"/><path d="M140 150l40-24 40 16 44-42" fill="none" stroke="#fff" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>',
    spark:    '<path d="M200 84l14 66 66 14-66 14-14 66-14-66-66-14 66-14z" fill="#fff" opacity=".9"/>',
    cap:      '<path d="M200 96l100 40-100 40-100-40z" fill="#fff" opacity=".9"/><path d="M148 152v40c0 12 24 24 52 24s52-12 52-24v-40" fill="none" stroke="#fff" stroke-width="6"/><path d="M280 136v46" stroke="#fff" stroke-width="6" stroke-linecap="round"/>',
    campus:   '<path d="M120 210V120l80-40 80 40v90" fill="none" stroke="#fff" stroke-width="6" stroke-linejoin="round"/><path d="M150 210v-60h100v60" fill="none" stroke="#fff" stroke-width="6"/><path d="M185 210v-34h30v34" fill="#fff" opacity=".85"/><path d="M120 210h160" stroke="#fff" stroke-width="6" stroke-linecap="round"/>'
  };

  function posterSvg(category) {
    const theme = CATEGORY_THEME[category] || DEFAULT_THEME;
    const icon = ICON_PATHS[theme.icon] || ICON_PATHS.spark;
    const gid = "g" + theme.icon;
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="400" height="300" viewBox="0 0 400 300">
      <defs>
        <linearGradient id="${gid}" x1="0" y1="0" x2="400" y2="300" gradientUnits="userSpaceOnUse">
          <stop offset="0" stop-color="${theme.grad.split(",")[1]}"/>
          <stop offset="1" stop-color="${theme.grad.split(",")[2]}"/>
        </linearGradient>
        <pattern id="p${gid}" width="26" height="26" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
          <line x1="0" y1="0" x2="0" y2="26" stroke="#ffffff" stroke-opacity="0.07" stroke-width="10"/>
        </pattern>
      </defs>
      <rect width="400" height="300" fill="url(#${gid})"/>
      <rect width="400" height="300" fill="url(#p${gid})"/>
      <circle cx="60" cy="40" r="120" fill="#ffffff" opacity="0.06"/>
      <circle cx="360" cy="270" r="90" fill="#000000" opacity="0.08"/>
  ...
  const posterCache = {};
  function posterFor(category) {
    if (!posterCache[category]) posterCache[category] = `url("${posterSvg(category)}")`;
    return posterCache[category];
  }
  ...
  function seedEvents() {
    ...
    return base.map((e, i) => {
      const id = "evt_" + (i + 1);
      return Object.assign({ id, image: posterFor(e.category) }, e);
    });
  }
  ...
  function seedGallery() {
    ...
    return names.map((n, i) => ({
      id: "gal_" + (i + 1),
      image: posterFor(cats[i % cats.length]),
      event: n,
  ...
  function eventCardHTML(ev, compact) {
    ...
    <article class="event-card" data-event-id="${ev.id}" tabindex="0" role="button" aria-label="View ${ev.title}">
      <div class="thumb glass-sheen" style="background-image:${ev.image}">
  ...
  function renderHome() {
    ...
    $("#memoriesRow").innerHTML = gallery.map(g => `
      <div class="memory-card glass-sheen" style="background-image:${g.image}" data-label="${g.event}"></div>`).join("");
  ...
  function openEventModal(id) {
    ...
    $("#eventModalBody").innerHTML = `
      <div class="em-hero glass-sheen" style="background-image:${ev.image}"></div>
  ...
  function renderProfile() {
    ...
    $("#profileSavedList").innerHTML = savedEvents.length ? savedEvents.map(e => `
      <div class="reg-card" data-event-id="${e.id}">
        <div class="thumb-sm glass-sheen" style="background-image:${e.image}"></div>
  ...
  function regCardHTML(r) {
    ...
    <div class="reg-card" data-event-id="${r.eventId}">
      <div class="thumb-sm glass-sheen" style="background-image:${ev ? ev.image : GRADIENTS[0]}"></div>
  ...
  function renderGallery() {
    ...
    $("#galleryGrid").innerHTML = lbList.map((g, i) => `
      <div class="gallery-item glass-sheen" data-idx="${i}">
        <div class="g-photo" style="background-image:${g.image}; padding-top:${70 + (i%3)*20}%;"></div>
  ...
  function updateLightbox() {
    ...
    if (!ph) {
      ...
      ph.id = "lbPlaceholder";
      ph.style.cssText = "width:min(90vw,520px); height:min(60vh,360px); border-radius:16px; background-size:cover; background-position:center; background-repeat:no-repeat;";
      img.parentElement.insertBefore(ph, img);
    }
    ph.style.backgroundImage = g.image;
  }
